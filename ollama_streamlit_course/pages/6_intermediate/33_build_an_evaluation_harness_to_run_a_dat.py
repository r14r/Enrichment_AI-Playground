...
st.set_page_config(page_title="33 - Build an evaluation harness to run a dat...", page_icon="📊")

st.title("📊 Build an evaluation harness to run a dat...")
st.write("""Build an evaluation harness to run a dataset of Q/A and compute accuracy metrics.""")
