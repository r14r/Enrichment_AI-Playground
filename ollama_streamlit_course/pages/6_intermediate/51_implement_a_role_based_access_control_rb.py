...
st.set_page_config(page_title="51 - Implement a role-based access control (R...", page_icon="🎯")

st.title("🎯 Implement a role-based access control (R...")
st.write("""Implement a role-based access control (RBAC) demo for admin vs user.""")
