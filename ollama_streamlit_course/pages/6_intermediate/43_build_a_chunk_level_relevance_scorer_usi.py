...
st.set_page_config(page_title="43 - Build a chunk-level relevance scorer usi...", page_icon="🎯")

st.title("🎯 Build a chunk-level relevance scorer usi...")
st.write("""Build a chunk-level relevance scorer using embeddings.""")
