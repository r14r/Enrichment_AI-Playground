...
st.set_page_config(page_title="59 - Add an export to static site option for ...", page_icon="🎯")

st.title("🎯 Add an export to static site option for ...")
st.write("""Add an export to static site option for Q/A knowledge base.""")
