...
st.set_page_config(page_title="29 - Implement a small workflow composer: cha...", page_icon="🎯")

st.title("🎯 Implement a small workflow composer: cha...")
st.write("""Implement a small workflow composer: chain prompts and pass outputs as inputs.""")
