...
st.set_page_config(page_title="15 - Add PDF ingestion and extraction for RAG...", page_icon="🎯")

st.title("🎯 Add PDF ingestion and extraction for RAG...")
st.write("""Add PDF ingestion and extraction for RAG demos.""")
