...
st.set_page_config(page_title="74 - Add an in-app training playground for pr...", page_icon="🎯")

st.title("🎯 Add an in-app training playground for pr...")
st.write("""Add an in-app training playground for prompt authors (sandboxed).""")
