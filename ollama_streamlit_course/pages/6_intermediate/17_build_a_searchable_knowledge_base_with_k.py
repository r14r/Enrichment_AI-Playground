...
st.set_page_config(page_title="17 - Build a searchable knowledge base with k...", page_icon="🔍")

st.title("🔍 Build a searchable knowledge base with k...")
st.write("""Build a searchable knowledge base with keyword and semantic search.""")
