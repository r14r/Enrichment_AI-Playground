...
st.set_page_config(page_title="69 - Implement a 'cost estimator' that comput...", page_icon="🎯")

st.title("🎯 Implement a 'cost estimator' that comput...")
st.write("""Implement a 'cost estimator' that computes estimated tokens/costs per request.""")
