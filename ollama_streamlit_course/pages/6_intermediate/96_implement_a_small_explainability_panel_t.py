...
st.set_page_config(page_title="96 - Implement a small 'explainability' panel...", page_icon="🎯")

st.title("🎯 Implement a small 'explainability' panel...")
st.write("""Implement a small 'explainability' panel that asks the model to justify answers.""")
