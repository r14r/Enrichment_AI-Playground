...
st.set_page_config(page_title="20 - Create a UI for few-shot prompting with ...", page_icon="🎯")

st.title("🎯 Create a UI for few-shot prompting with ...")
st.write("""Create a UI for few-shot prompting with example editor and dynamic insertion.""")
