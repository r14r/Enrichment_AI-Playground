...
st.set_page_config(page_title="94 - Create a 'stale answer detector' that fl...", page_icon="🏷️")

st.title("🏷️ Create a 'stale answer detector' that fl...")
st.write("""Create a 'stale answer detector' that flags answers that reference old info.""")
