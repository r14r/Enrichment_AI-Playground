...
st.set_page_config(page_title="68 - Add a 'safety filter' pipeline that bloc...", page_icon="🔒")

st.title("🔒 Add a 'safety filter' pipeline that bloc...")
st.write("""Add a 'safety filter' pipeline that blocks or flags risky outputs.""")
