...
st.set_page_config(page_title="79 - Build a small microservice that exposes ...", page_icon="🔍")

st.title("🔍 Build a small microservice that exposes ...")
st.write("""Build a small microservice that exposes the app's search API.""")
