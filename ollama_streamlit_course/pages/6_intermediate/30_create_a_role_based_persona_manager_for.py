...
st.set_page_config(page_title="30 - Create a role-based persona manager for ...", page_icon="🎯")

st.title("🎯 Create a role-based persona manager for ...")
st.write("""Create a role-based persona manager for assistants.""")
