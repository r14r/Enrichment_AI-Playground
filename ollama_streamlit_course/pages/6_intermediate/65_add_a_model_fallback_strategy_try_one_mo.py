...
st.set_page_config(page_title="65 - Add a 'model fallback' strategy: try one...", page_icon="🎯")

st.title("🎯 Add a 'model fallback' strategy: try one...")
st.write("""Add a 'model fallback' strategy: try one model, fallback to another on error.""")
