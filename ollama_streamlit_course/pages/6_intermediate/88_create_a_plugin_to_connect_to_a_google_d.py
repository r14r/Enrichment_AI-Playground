...
st.set_page_config(page_title="88 - Create a plugin to connect to a Google D...", page_icon="🎯")

st.title("🎯 Create a plugin to connect to a Google D...")
st.write("""Create a plugin to connect to a Google Drive folder for ingestion.""")
