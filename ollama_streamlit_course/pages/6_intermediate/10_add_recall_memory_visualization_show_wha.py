...
st.set_page_config(page_title="10 - Add recall / memory visualization: show ...", page_icon="🎯")

st.title("🎯 Add recall / memory visualization: show ...")
st.write("""Add recall / memory visualization: show what memory was used in responses.""")
