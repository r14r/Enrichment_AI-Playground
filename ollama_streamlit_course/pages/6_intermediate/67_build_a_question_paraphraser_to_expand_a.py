...
st.set_page_config(page_title="67 - Build a 'question paraphraser' to expand...", page_icon="🎯")

st.title("🎯 Build a 'question paraphraser' to expand...")
st.write("""Build a 'question paraphraser' to expand a user question into multiple variations for robust retrieval.""")
