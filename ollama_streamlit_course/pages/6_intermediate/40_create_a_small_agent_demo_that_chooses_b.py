...
st.set_page_config(page_title="40 - Create a small 'agent' demo that chooses...", page_icon="🔍")

st.title("🔍 Create a small 'agent' demo that chooses...")
st.write("""Create a small 'agent' demo that chooses between search and generation steps.""")
