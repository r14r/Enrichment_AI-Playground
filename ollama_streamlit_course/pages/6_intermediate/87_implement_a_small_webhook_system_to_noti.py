...
st.set_page_config(page_title="87 - Implement a small webhook system to noti...", page_icon="🎯")

st.title("🎯 Implement a small webhook system to noti...")
st.write("""Implement a small webhook system to notify downstream services on events.""")
