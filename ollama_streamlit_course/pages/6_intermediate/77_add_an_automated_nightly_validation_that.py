...
st.set_page_config(page_title="77 - Add an automated nightly validation that...", page_icon="🎯")

st.title("🎯 Add an automated nightly validation that...")
st.write("""Add an automated nightly validation that re-runs QA on a sample dataset.""")
