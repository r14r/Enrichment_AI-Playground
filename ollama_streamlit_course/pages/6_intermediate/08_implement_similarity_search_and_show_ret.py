...
st.set_page_config(page_title="8 - Implement similarity search and show ret...", page_icon="🔍")

st.title("🔍 Implement similarity search and show ret...")
st.write("""Implement similarity search and show retrieved passages used in the prompt.""")
