...
st.set_page_config(page_title="49 - Build a small visualization of token usa...", page_icon="🎯")

st.title("🎯 Build a small visualization of token usa...")
st.write("""Build a small visualization of token usage over time per user.""")
