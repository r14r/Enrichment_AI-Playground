...
st.set_page_config(page_title="90 - Implement a 'knowledge graph' builder th...", page_icon="🎯")

st.title("🎯 Implement a 'knowledge graph' builder th...")
st.write("""Implement a 'knowledge graph' builder that extracts entities and relations.""")
