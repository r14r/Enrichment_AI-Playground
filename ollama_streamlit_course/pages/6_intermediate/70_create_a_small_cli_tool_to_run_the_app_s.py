...
st.set_page_config(page_title="70 - Create a small CLI tool to run the app's...", page_icon="🎯")

st.title("🎯 Create a small CLI tool to run the app's...")
st.write("""Create a small CLI tool to run the app's ingestion and indexing separately.""")
