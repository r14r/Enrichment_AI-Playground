...
st.set_page_config(page_title="11 - Create a UI to show which retrieved docu...", page_icon="📁")

st.title("📁 Create a UI to show which retrieved docu...")
st.write("""Create a UI to show which retrieved documents influenced the answer (transparency).""")
