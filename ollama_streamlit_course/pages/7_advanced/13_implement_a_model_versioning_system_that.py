...
st.set_page_config(page_title="13 - Implement a model versioning system that...", page_icon="🎯")

st.title("🎯 Implement a model versioning system that...")
st.write("""Implement a model versioning system that lets you switch models per environment.""")
