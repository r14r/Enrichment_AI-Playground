...
st.set_page_config(page_title="90 - Add privacy-preserving embeddings (e.g.,...", page_icon="🎯")

st.title("🎯 Add privacy-preserving embeddings (e.g.,...")
st.write("""Add privacy-preserving embeddings (e.g., hashed / transformed embeddings) experiments.""")
