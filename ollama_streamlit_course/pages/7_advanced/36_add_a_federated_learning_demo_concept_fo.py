...
st.set_page_config(page_title="36 - Add a federated learning demo concept fo...", page_icon="🎯")

st.title("🎯 Add a federated learning demo concept fo...")
st.write("""Add a federated learning demo concept for private data across clients.""")
