...
st.set_page_config(page_title="87 - Add tools for automated dataset labeling...", page_icon="🎯")

st.title("🎯 Add tools for automated dataset labeling...")
st.write("""Add tools for automated dataset labeling using weak supervision and model proposals.""")
