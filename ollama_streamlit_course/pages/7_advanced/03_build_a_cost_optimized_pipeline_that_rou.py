...
st.set_page_config(page_title="3 - Build a cost-optimized pipeline that rou...", page_icon="🎯")

st.title("🎯 Build a cost-optimized pipeline that rou...")
st.write("""Build a cost-optimized pipeline that routes heavy jobs to scheduled batch runs.""")
