...
st.set_page_config(page_title="46 - Implement a large-scale synthetic data g...", page_icon="✨")

st.title("✨ Implement a large-scale synthetic data g...")
st.write("""Implement a large-scale synthetic data generator for specialized domains.""")
