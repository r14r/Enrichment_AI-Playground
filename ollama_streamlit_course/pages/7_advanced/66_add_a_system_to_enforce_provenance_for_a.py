...
st.set_page_config(page_title="66 - Add a system to enforce provenance for a...", page_icon="🎯")

st.title("🎯 Add a system to enforce provenance for a...")
st.write("""Add a system to enforce provenance for answers (show exact source passages).""")
