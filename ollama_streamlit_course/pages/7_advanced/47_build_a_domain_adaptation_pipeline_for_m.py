...
st.set_page_config(page_title="47 - Build a domain adaptation pipeline for m...", page_icon="🎯")

st.title("🎯 Build a domain adaptation pipeline for m...")
st.write("""Build a domain adaptation pipeline for moving models to a niche domain.""")
