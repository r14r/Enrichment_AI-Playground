...
st.set_page_config(page_title="75 - Add an experiment to compare chain-of-th...", page_icon="🎯")

st.title("🎯 Add an experiment to compare chain-of-th...")
st.write("""Add an experiment to compare chain-of-thought vs. direct answer formats for reasoning tasks.""")
