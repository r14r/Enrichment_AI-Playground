...
st.set_page_config(page_title="74 - Create an offline QA dataset generator f...", page_icon="✨")

st.title("✨ Create an offline QA dataset generator f...")
st.write("""Create an offline QA dataset generator from large corpora.""")
