...
st.set_page_config(page_title="27 - Add a feature store for embeddings and d...", page_icon="🎯")

st.title("🎯 Add a feature store for embeddings and d...")
st.write("""Add a feature store for embeddings and derived features.""")
