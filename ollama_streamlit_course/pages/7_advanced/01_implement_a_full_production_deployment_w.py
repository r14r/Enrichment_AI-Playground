...
st.set_page_config(page_title="1 - Implement a full production deployment w...", page_icon="🚀")

st.title("🚀 Implement a full production deployment w...")
st.write("""Implement a full production deployment with Docker and systemd service example.""")
