...
st.set_page_config(page_title="69 - Add an advanced metric suite for halluci...", page_icon="📊")

st.title("📊 Add an advanced metric suite for halluci...")
st.write("""Add an advanced metric suite for hallucination detection specific to your domain.""")
