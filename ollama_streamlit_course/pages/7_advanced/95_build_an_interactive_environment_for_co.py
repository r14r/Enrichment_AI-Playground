...
st.set_page_config(page_title="95 - Build an interactive environment for co-...", page_icon="🎯")

st.title("🎯 Build an interactive environment for co-...")
st.write("""Build an interactive environment for co-design with domain experts (feedback loop).""")
