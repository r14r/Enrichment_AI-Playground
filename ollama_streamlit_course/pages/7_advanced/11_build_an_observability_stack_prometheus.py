...
st.set_page_config(page_title="11 - Build an observability stack: Prometheus...", page_icon="📊")

st.title("📊 Build an observability stack: Prometheus...")
st.write("""Build an observability stack: Prometheus metrics, Grafana dashboards for latency and errors.""")
