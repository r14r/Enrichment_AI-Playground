...
st.set_page_config(page_title="26 - Create a human-in-the-loop review flow f...", page_icon="🎯")

st.title("🎯 Create a human-in-the-loop review flow f...")
st.write("""Create a human-in-the-loop review flow for labeling and improving models.""")
