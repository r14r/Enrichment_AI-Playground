...
st.set_page_config(page_title="80 - Create advanced image+text retrieval dem...", page_icon="🎯")

st.title("🎯 Create advanced image+text retrieval dem...")
st.write("""Create advanced image+text retrieval demos using embeddings with multimodal models.""")
