...
st.set_page_config(page_title="87 - Implement a 'simple sanity-check' that d...", page_icon="🏷️")

st.title("🏷️ Implement a 'simple sanity-check' that d...")
st.write("""Implement a 'simple sanity-check' that detects likely hallucinations (heuristic via prompt).""")
