...
st.set_page_config(page_title="3 - Implement a prompt input with a submit b...", page_icon="🎯")

st.title("🎯 Implement a prompt input with a submit b...")
st.write("""Implement a prompt input with a submit button and show raw JSON response from Ollama.""")
