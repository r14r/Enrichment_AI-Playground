...
st.set_page_config(page_title="33 - Implement a 'title case / sentence case'...", page_icon="🎯")

st.title("🎯 Implement a 'title case / sentence case'...")
st.write("""Implement a 'title case / sentence case' transformer via model prompt.""")
