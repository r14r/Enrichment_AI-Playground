...
st.set_page_config(page_title="62 - Create a system to synthesize adversaria...", page_icon="🎯")

st.title("🎯 Create a system to synthesize adversaria...")
st.write("""Create a system to synthesize adversarial prompts and measure robustness.""")
