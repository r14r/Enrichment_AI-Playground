...
st.set_page_config(page_title="30 - Add a multi-agent orchestration demo whe...", page_icon="🎯")

st.title("🎯 Add a multi-agent orchestration demo whe...")
st.write("""Add a multi-agent orchestration demo where agents pass messages to achieve a goal.""")
