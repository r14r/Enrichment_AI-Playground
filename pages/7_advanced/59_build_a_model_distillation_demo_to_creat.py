...
st.set_page_config(page_title="59 - Build a model distillation demo to creat...", page_icon="🎯")

st.title("🎯 Build a model distillation demo to creat...")
st.write("""Build a model distillation demo to create lightweight models from heavy models.""")
