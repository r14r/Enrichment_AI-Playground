...
st.set_page_config(page_title="96 - Add long-term archival strategies for ol...", page_icon="🎯")

st.title("🎯 Add long-term archival strategies for ol...")
st.write("""Add long-term archival strategies for old indexes and retraining resources.""")
