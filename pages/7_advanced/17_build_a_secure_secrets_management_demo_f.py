...
st.set_page_config(page_title="17 - Build a secure secrets management demo f...", page_icon="🎯")

st.title("🎯 Build a secure secrets management demo f...")
st.write("""Build a secure secrets management demo for API keys and credentials.""")
