...
st.set_page_config(page_title="19 - Implement adversarial example generation...", page_icon="✨")

st.title("✨ Implement adversarial example generation...")
st.write("""Implement adversarial example generation and evaluation.""")
