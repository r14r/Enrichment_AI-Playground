...
st.set_page_config(page_title="83 - Build a 'model blending' ensemble that m...", page_icon="🎯")

st.title("🎯 Build a 'model blending' ensemble that m...")
st.write("""Build a 'model blending' ensemble that merges outputs from multiple models.""")
