...
st.set_page_config(page_title="8 - Build a retrieval layer with hybrid sear...", page_icon="🔍")

st.title("🔍 Build a retrieval layer with hybrid sear...")
st.write("""Build a retrieval layer with hybrid search (BM25 + embeddings) and compare results.""")
