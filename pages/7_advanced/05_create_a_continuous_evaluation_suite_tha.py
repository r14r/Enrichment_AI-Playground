...
st.set_page_config(page_title="5 - Create a continuous evaluation suite tha...", page_icon="🎯")

st.title("🎯 Create a continuous evaluation suite tha...")
st.write("""Create a continuous evaluation suite that runs benchmarks on model changes.""")
