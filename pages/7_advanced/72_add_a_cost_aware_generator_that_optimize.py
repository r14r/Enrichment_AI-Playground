...
st.set_page_config(page_title="72 - Add a cost-aware generator that optimize...", page_icon="✨")

st.title("✨ Add a cost-aware generator that optimize...")
st.write("""Add a cost-aware generator that optimizes prompt length vs result quality.""")
