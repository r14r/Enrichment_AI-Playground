...
st.set_page_config(page_title="70 - Implement on-call automation for when mo...", page_icon="🎯")

st.title("🎯 Implement on-call automation for when mo...")
st.write("""Implement on-call automation for when model endpoints violate SLAs.""")
