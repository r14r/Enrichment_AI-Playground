...
st.set_page_config(page_title="86 - Create a long-context evaluation environ...", page_icon="🧪")

st.title("🧪 Create a long-context evaluation environ...")
st.write("""Create a long-context evaluation environment to test context window strategies.""")
