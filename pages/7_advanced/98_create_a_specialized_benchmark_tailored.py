...
st.set_page_config(page_title="98 - Create a specialized benchmark tailored ...", page_icon="🎯")

st.title("🎯 Create a specialized benchmark tailored ...")
st.write("""Create a specialized benchmark tailored to your domain and measure improvements.""")
