...
st.set_page_config(page_title="32 - Create an automated data curation pipeli...", page_icon="🎯")

st.title("🎯 Create an automated data curation pipeli...")
st.write("""Create an automated data curation pipeline with quality checks.""")
