...
st.set_page_config(page_title="20 - Create a benchmark harness comparing thr...", page_icon="🎯")

st.title("🎯 Create a benchmark harness comparing thr...")
st.write("""Create a benchmark harness comparing throughput and latency of model endpoints.""")
