...
st.set_page_config(page_title="41 - Build a producer/consumer architecture f...", page_icon="✨")

st.title("✨ Build a producer/consumer architecture f...")
st.write("""Build a producer/consumer architecture for heavy generation workloads.""")
