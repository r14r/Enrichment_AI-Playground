...
st.set_page_config(page_title="18 - Add automated data augmentation workflow...", page_icon="🎯")

st.title("🎯 Add automated data augmentation workflow...")
st.write("""Add automated data augmentation workflows for increasing training examples.""")
