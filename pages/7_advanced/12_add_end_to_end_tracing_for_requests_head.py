...
st.set_page_config(page_title="12 - Add end-to-end tracing for requests (hea...", page_icon="🎯")

st.title("🎯 Add end-to-end tracing for requests (hea...")
st.write("""Add end-to-end tracing for requests (headers, prompt, retrieval traces).""")
