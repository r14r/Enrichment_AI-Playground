...
st.set_page_config(page_title="99 - Add tooling for legal and regulatory com...", page_icon="🎯")

st.title("🎯 Add tooling for legal and regulatory com...")
st.write("""Add tooling for legal and regulatory compliance checks (data use policies).""")
