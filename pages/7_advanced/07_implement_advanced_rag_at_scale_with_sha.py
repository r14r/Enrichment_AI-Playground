...
st.set_page_config(page_title="7 - Implement advanced RAG at scale with sha...", page_icon="🎯")

st.title("🎯 Implement advanced RAG at scale with sha...")
st.write("""Implement advanced RAG at scale with sharded vector indexes.""")
