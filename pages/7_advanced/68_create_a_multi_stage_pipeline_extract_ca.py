...
st.set_page_config(page_title="68 - Create a multi-stage pipeline: extract →...", page_icon="🎯")

st.title("🎯 Create a multi-stage pipeline: extract →...")
st.write("""Create a multi-stage pipeline: extract → canonicalize → index → serve.""")
