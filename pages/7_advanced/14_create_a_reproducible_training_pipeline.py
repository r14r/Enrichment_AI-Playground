...
st.set_page_config(page_title="14 - Create a reproducible training pipeline ...", page_icon="🚀")

st.title("🚀 Create a reproducible training pipeline ...")
st.write("""Create a reproducible training pipeline using Docker/Make and explicit seeds.""")
