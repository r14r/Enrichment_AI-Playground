...
st.set_page_config(page_title="53 - Build an interactive visualization of em...", page_icon="🎯")

st.title("🎯 Build an interactive visualization of em...")
st.write("""Build an interactive visualization of embedding spaces and cluster explanations.""")
