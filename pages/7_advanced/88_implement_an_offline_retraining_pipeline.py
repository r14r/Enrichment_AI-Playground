...
st.set_page_config(page_title="88 - Implement an offline retraining pipeline...", page_icon="🎯")

st.title("🎯 Implement an offline retraining pipeline...")
st.write("""Implement an offline retraining pipeline triggered by human-labeled corrections.""")
