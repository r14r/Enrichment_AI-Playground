...
st.set_page_config(page_title="42 - Add a privacy audit tool that scans inge...", page_icon="🎯")

st.title("🎯 Add a privacy audit tool that scans inge...")
st.write("""Add a privacy audit tool that scans ingested docs for sensitive patterns.""")
