...
st.set_page_config(page_title="77 - Build a governance dashboard: who ran wh...", page_icon="📊")

st.title("📊 Build a governance dashboard: who ran wh...")
st.write("""Build a governance dashboard: who ran what prompt, when, and what data used.""")
