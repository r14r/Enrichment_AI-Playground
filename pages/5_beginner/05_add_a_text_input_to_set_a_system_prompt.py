...
st.set_page_config(page_title="5 - Add a text input to set a system prompt ...", page_icon="🎯")

st.title("🎯 Add a text input to set a system prompt ...")
st.write("""Add a text input to set a system prompt (persona) and prepend it to messages.""")
