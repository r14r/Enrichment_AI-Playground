...
st.set_page_config(page_title="28 - Add a file uploader for .txt and impleme...", page_icon="📁")

st.title("📁 Add a file uploader for .txt and impleme...")
st.write("""Add a file uploader for .txt and implement summarization of uploaded text.""")
