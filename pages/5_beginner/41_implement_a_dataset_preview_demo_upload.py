...
st.set_page_config(page_title="41 - Implement a 'dataset preview' demo: uplo...", page_icon="📁")

st.title("📁 Implement a 'dataset preview' demo: uplo...")
st.write("""Implement a 'dataset preview' demo: upload CSV, create a natural language summary of columns.""")
