...
st.set_page_config(page_title="74 - Build a 'short survey summarizer' that t...", page_icon="📝")

st.title("📝 Build a 'short survey summarizer' that t...")
st.write("""Build a 'short survey summarizer' that turns a few responses into bullet insights.""")
