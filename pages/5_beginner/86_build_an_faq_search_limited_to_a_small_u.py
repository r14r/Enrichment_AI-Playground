...
st.set_page_config(page_title="86 - Build an 'FAQ search' limited to a small...", page_icon="🔍")

st.title("🔍 Build an 'FAQ search' limited to a small...")
st.write("""Build an 'FAQ search' limited to a small uploaded doc (match via prompt only).""")
