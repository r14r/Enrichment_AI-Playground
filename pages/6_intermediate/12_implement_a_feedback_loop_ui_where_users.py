...
st.set_page_config(page_title="12 - Implement a feedback loop UI where users...", page_icon="🎯")

st.title("🎯 Implement a feedback loop UI where users...")
st.write("""Implement a feedback loop UI where users can rate model outputs and store ratings.""")
