...
st.set_page_config(page_title="28 - Add a prompt scheduler that runs prompts...", page_icon="🎯")

st.title("🎯 Add a prompt scheduler that runs prompts...")
st.write("""Add a prompt scheduler that runs prompts at intervals and stores outputs.""")
