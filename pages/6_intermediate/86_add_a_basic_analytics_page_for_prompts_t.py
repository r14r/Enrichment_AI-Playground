...
st.set_page_config(page_title="86 - Add a basic analytics page for prompts, ...", page_icon="📊")

st.title("📊 Add a basic analytics page for prompts, ...")
st.write("""Add a basic analytics page for prompts, top users, and trends.""")
