...
st.set_page_config(page_title="21 - Build a compare-mode: give two prompts, ...", page_icon="🎯")

st.title("🎯 Build a compare-mode: give two prompts, ...")
st.write("""Build a compare-mode: give two prompts, run both, and show differences.""")
