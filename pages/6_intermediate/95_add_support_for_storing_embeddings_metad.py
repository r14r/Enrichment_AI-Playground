...
st.set_page_config(page_title="95 - Add support for storing embeddings metad...", page_icon="🎯")

st.title("🎯 Add support for storing embeddings metad...")
st.write("""Add support for storing embeddings metadata for filtering (date, source).""")
