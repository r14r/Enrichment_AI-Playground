...
st.set_page_config(page_title="42 - Implement a 'translation pipeline' combi...", page_icon="📝")

st.title("📝 Implement a 'translation pipeline' combi...")
st.write("""Implement a 'translation pipeline' combining detection, translation, and summarization.""")
