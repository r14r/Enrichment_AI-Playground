...
st.set_page_config(page_title="64 - Create a 'fine-grained prompt templating...", page_icon="🎯")

st.title("🎯 Create a 'fine-grained prompt templating...")
st.write("""Create a 'fine-grained prompt templating' editor with input placeholders.""")
