...
st.set_page_config(page_title="72 - Implement a 'session export' to JSON wit...", page_icon="🎯")

st.title("🎯 Implement a 'session export' to JSON wit...")
st.write("""Implement a 'session export' to JSON with all relevant artifacts.""")
