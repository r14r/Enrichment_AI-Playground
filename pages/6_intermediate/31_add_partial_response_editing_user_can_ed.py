...
st.set_page_config(page_title="31 - Add partial response editing (user can e...", page_icon="🎯")

st.title("🎯 Add partial response editing (user can e...")
st.write("""Add partial response editing (user can edit model reply and resend for refinement).""")
