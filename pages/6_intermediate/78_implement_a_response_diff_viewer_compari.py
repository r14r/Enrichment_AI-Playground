...
st.set_page_config(page_title="78 - Implement a 'response diff' viewer compa...", page_icon="🎯")

st.title("🎯 Implement a 'response diff' viewer compa...")
st.write("""Implement a 'response diff' viewer comparing two model versions.""")
