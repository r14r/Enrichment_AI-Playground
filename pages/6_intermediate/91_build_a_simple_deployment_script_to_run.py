...
st.set_page_config(page_title="91 - Build a simple deployment script to run ...", page_icon="🚀")

st.title("🚀 Build a simple deployment script to run ...")
st.write("""Build a simple deployment script to run the app in Docker.""")
