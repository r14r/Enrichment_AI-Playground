...
st.set_page_config(page_title="4 - Implement a prompt history manager with ...", page_icon="🎯")

st.title("🎯 Implement a prompt history manager with ...")
st.write("""Implement a prompt history manager with versioned templates.""")
