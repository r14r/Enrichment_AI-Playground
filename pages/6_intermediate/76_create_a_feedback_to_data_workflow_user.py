...
st.set_page_config(page_title="76 - Create a 'feedback-to-data' workflow: us...", page_icon="🎯")

st.title("🎯 Create a 'feedback-to-data' workflow: us...")
st.write("""Create a 'feedback-to-data' workflow: user corrections become labeled examples.""")
