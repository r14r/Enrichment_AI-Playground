...
st.set_page_config(page_title="97 - Build a 'batch QA' feature for processin...", page_icon="🎯")

st.title("🎯 Build a 'batch QA' feature for processin...")
st.write("""Build a 'batch QA' feature for processing CSV of questions.""")
