...
st.set_page_config(page_title="89 - Add a 'compare retrieval algorithms' exp...", page_icon="🎯")

st.title("🎯 Add a 'compare retrieval algorithms' exp...")
st.write("""Add a 'compare retrieval algorithms' experiment runner.""")
