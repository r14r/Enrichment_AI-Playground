...
st.set_page_config(page_title="24 - Create an insights dashboard: average la...", page_icon="📊")

st.title("📊 Create an insights dashboard: average la...")
st.write("""Create an insights dashboard: average latency, tokens used, top prompts.""")
