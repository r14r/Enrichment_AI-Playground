...
st.set_page_config(page_title="18 - Add caching of recent retrievals and res...", page_icon="🎯")

st.title("🎯 Add caching of recent retrievals and res...")
st.write("""Add caching of recent retrievals and responses to speed up common queries.""")
