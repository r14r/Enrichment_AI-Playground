...
st.set_page_config(page_title="57 - Implement an ingestion pipeline for HTML...", page_icon="🎯")

st.title("🎯 Implement an ingestion pipeline for HTML...")
st.write("""Implement an ingestion pipeline for HTML pages and metadata extraction.""")
