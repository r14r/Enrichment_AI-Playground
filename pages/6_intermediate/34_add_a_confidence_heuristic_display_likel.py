...
st.set_page_config(page_title="34 - Add a 'confidence' heuristic display (li...", page_icon="🎯")

st.title("🎯 Add a 'confidence' heuristic display (li...")
st.write("""Add a 'confidence' heuristic display (likelihood or proxy score) for outputs.""")
