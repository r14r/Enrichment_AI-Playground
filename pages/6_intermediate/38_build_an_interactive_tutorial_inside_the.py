...
st.set_page_config(page_title="38 - Build an interactive tutorial inside the...", page_icon="🎯")

st.title("🎯 Build an interactive tutorial inside the...")
st.write("""Build an interactive tutorial inside the app that guides users through features.""")
