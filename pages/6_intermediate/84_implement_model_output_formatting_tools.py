...
st.set_page_config(page_title="84 - Implement model output formatting tools ...", page_icon="🎯")

st.title("🎯 Implement model output formatting tools ...")
st.write("""Implement model output formatting tools (e.g., force JSON structures).""")
