...
st.set_page_config(page_title="87 – Content: CSV → Visualisierungsideen", page_icon="📄")
st.title("📄 87 – Content: CSV → Visualisierungsideen (Ausführlich)")
...
if st.button("CSV analysieren"):
    if not file:
        ...
        prompt = "Schlage geeignete Visualisierungstypen vor, um die Daten darzustellen." + "\n\nHier sind die ersten Zeilen der CSV-Datei:\n" + csv_preview
