...
st.title("🖼️ 45 – Media: Emotionen im Bild (Ausführlich)")
...
question = st.text_area("Aufgabe an das Modell", "Beschreibe die Emotionen und Stimmung, die das Bild vermittelt, und erkläre, welche Bildelemente dazu beitragen.", height=150)
