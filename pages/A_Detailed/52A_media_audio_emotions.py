...
st.title("🎧 52 – Media: Emotionen im Audio (Ausführlich)")
...
if st.button("Ausführen"):
    if not text.strip():
        ...
        prompt = "Analysiere anhand des Transkripts die Stimmung und Emotionen der sprechenden Person und beschreibe sie." + "\n\nText:\n" + text.strip()
        if extra.strip():
            prompt += "\n\nZusatz:\n" + extra.strip()
