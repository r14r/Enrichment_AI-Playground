...
st.title("🎧 58 – Media: Sprechstil analysieren (Ausführlich)")
...
if st.button("Ausführen"):
    if not text.strip():
        ...
        prompt = "Beschreibe den Sprechstil (z. B. ruhig, hektisch, sachlich, motivierend) und begründe kurz deine Einschätzung." + "\n\nText:\n" + text.strip()
        if extra.strip():
            prompt += "\n\nZusatz:\n" + extra.strip()
