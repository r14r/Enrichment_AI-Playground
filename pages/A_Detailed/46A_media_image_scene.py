...
st.set_page_config(page_title="46 – Media: Szenerie-Analyse", page_icon="🖼️")
st.title("🖼️ 46 – Media: Szenerie-Analyse (Ausführlich)")
...
question = st.text_area("Aufgabe an das Modell", "Analysiere die Szenerie: innen oder außen, Tageszeit, Lichtstimmung und Umgebung, und beschreibe diese Faktoren kurz.", height=150)
