...
st.title("📊 90 – Data: CSV-Statistik-Report (Ausführlich)")
...
if st.button("CSV analysieren"):
    if not file:
        ...
        prompt = "Erstelle einen kurzen Statistik-Report zu den Daten (wenn möglich: Bereiche, Verteilungen, Auffälligkeiten)." + "\n\nHier sind die ersten Zeilen der CSV-Datei:\n" + csv_preview
