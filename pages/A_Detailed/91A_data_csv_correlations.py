...
st.set_page_config(page_title="91 – Data: CSV-Korrelationen", page_icon="📊")
st.title("📊 91 – Data: CSV-Korrelationen (Ausführlich)")
...
if st.button("CSV analysieren"):
    if not file:
        ...
        prompt = "Beschreibe mögliche Zusammenhänge zwischen numerischen Spalten, soweit aus dem Ausschnitt erkennbar." + "\n\nHier sind die ersten Zeilen der CSV-Datei:\n" + csv_preview
