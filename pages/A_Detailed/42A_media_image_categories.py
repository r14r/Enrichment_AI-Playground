...
st.title("🖼️ 42 – Media: Bildkategorien (Ausführlich)")
...
question = st.text_area("Aufgabe an das Modell", "Ordne das Bild in passende thematische Kategorien ein (z. B. Natur, Stadt, Menschen, Technik) und begründe kurz.", height=150)
