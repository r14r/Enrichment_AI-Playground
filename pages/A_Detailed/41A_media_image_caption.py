...
st.set_page_config(page_title="41 – Media: Bildbeschreibung", page_icon="🖼️")
st.title("🖼️ 41 – Media: Bildbeschreibung (Ausführlich)")
...
question = st.text_area("Aufgabe an das Modell", "Beschreibe das Bild in 3–5 Sätzen so, dass sich jemand ohne Bild eine gute Vorstellung machen kann.", height=150)
