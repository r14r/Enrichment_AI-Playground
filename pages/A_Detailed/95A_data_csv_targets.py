...
st.set_page_config(page_title="95 – Data: CSV-Zielvariable", page_icon="📊")
st.title("📊 95 – Data: CSV-Zielvariable (Ausführlich)")
...
if st.button("CSV analysieren"):
    if not file:
        ...
        prompt = "Vermute, welche Spalte als Zielvariable in einem ML-Modell dienen könnte und warum." + "\n\nHier sind die ersten Zeilen der CSV-Datei:\n" + csv_preview
