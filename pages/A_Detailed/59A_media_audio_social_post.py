...
st.title("🎧 59 – Media: Social-Media-Post aus Audio (Ausführlich)")
...
if st.button("Ausführen"):
    if not text.strip():
        ...
        prompt = "Erzeuge aus dem Transkript einen knackigen Social-Media-Post, der den Inhalt attraktiv zusammenfasst." + "\n\nText:\n" + text.strip()
        if extra.strip():
            prompt += "\n\nZusatz:\n" + extra.strip()
