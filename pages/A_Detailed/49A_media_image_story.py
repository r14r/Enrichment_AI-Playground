...
st.title("🖼️ 49 – Media: Bild-Story (Ausführlich)")
...
question = st.text_area("Aufgabe an das Modell", "Erfinde eine kurze Geschichte (5–8 Sätze), die zu diesem Bild passt.", height=150)
