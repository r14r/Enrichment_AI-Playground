...
st.title("🎥 62 – Media: Kapitel & Timestamps (Ausführlich)")
...
if st.button("Ausführen"):
    if not text.strip():
        ...
        prompt = "Schlage sinnvolle Kapitelüberschriften vor und gib geschätzte Positionen im Video (z. B. Anfang/Mitte/Ende) an." + "\n\nText:\n" + text.strip()
        if extra.strip():
            prompt += "\n\nZusatz:\n" + extra.strip()
