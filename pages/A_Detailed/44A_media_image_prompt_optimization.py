...
st.title("🖼️ 44 – Media: Prompt-Optimierung (Ausführlich)")
...
question = st.text_area("Aufgabe an das Modell", "Formuliere einen optimierten Prompt für ein Text-zu-Bild-Modell, um ein Bild zu erzeugen, das dem hochgeladenen Bild möglichst ähnlich ist.", height=150)
