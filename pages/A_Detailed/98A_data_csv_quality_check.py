...
st.set_page_config(page_title="98 – Data: CSV-Qualitätscheck", page_icon="📊")
st.title("📊 98 – Data: CSV-Qualitätscheck (Ausführlich)")
...
if st.button("CSV analysieren"):
    if not file:
        ...
        prompt = "Beurteile die Datenqualität kurz (fehlende Werte, Konsistenz, mögliche Probleme)." + "\n\nHier sind die ersten Zeilen der CSV-Datei:\n" + csv_preview
