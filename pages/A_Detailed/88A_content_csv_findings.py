...
st.set_page_config(page_title="88 – Content: CSV → Erkenntnisse", page_icon="📄")
st.title("📄 88 – Content: CSV → Erkenntnisse (Ausführlich)")
...
if st.button("CSV analysieren"):
    if not file:
        ...
        prompt = "Formuliere mögliche Erkenntnisse und Hypothesen basierend auf den Daten." + "\n\nHier sind die ersten Zeilen der CSV-Datei:\n" + csv_preview
