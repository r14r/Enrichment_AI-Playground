...
st.title("🖼️ 47 – Media: Logos & Symbole (Ausführlich)")
...
question = st.text_area("Aufgabe an das Modell", "Suche nach Logos oder markanten Symbolen im Bild, beschreibe sie und ordne sie falls möglich bekannten Marken oder Bedeutungen zu.", height=150)
