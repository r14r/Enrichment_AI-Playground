...
st.set_page_config(page_title="40 – Media: Bildklassifikation", page_icon="🖼️")
st.title("🖼️ 40 – Media: Bildklassifikation (Ausführlich)")
...
question = st.text_area("Aufgabe an das Modell", "Analysiere das Bild und liste die wichtigsten erkennbaren Objekte mit kurzen Beschreibungen auf.", height=150)
