...
st.set_page_config(page_title="86 – Content: CSV-Datenqualität", page_icon="📄")
st.title("📄 86 – Content: CSV-Datenqualität (Ausführlich)")
...
if st.button("CSV analysieren"):
    if not file:
        ...
        prompt = "Beurteile die Datenqualität anhand der Ausschnitte (fehlende Werte, Ausreißer etc.)." + "\n\nHier sind die ersten Zeilen der CSV-Datei:\n" + csv_preview
