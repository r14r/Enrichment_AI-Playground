...
st.set_page_config(page_title="43 – Media: Bildästhetik", page_icon="🖼️")
st.title("🖼️ 43 – Media: Bildästhetik (Ausführlich)")
...
question = st.text_area("Aufgabe an das Modell", "Bewerte die Ästhetik und Bildqualität auf einer Skala von 1 bis 10 und erläutere, warum du diese Bewertung gibst.", height=150)
