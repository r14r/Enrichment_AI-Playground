...
st.title("027 – Prompting: Vergleiche (Ausführlich)")

st.markdown("**Lernziel:** Vergleiche Aspekte strukturiert oder tabellarisch.")
...
if st.button("Ausführen"):
    if not txt.strip():
        ...
        prompt = "Vergleiche Aspekte strukturiert oder tabellarisch." + "\n\nText:\n" + txt.strip()
        if extra.strip():
            prompt += "\n\nZusatz:\n" + extra.strip()
