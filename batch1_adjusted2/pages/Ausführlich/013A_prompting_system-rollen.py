...
st.title("013 – Prompting: System-Rollen (Ausführlich)")

st.markdown("**Lernziel:** Analysiere, wie sich der System-Prompt auf die Antwort auswirkt.")
...
if st.button("Ausführen"):
    if not txt.strip():
        ...
        prompt = "Analysiere, wie sich der System-Prompt auf die Antwort auswirkt." + "\n\nText:\n" + txt.strip()
        if extra.strip():
            prompt += "\n\nZusatz:\n" + extra.strip()
