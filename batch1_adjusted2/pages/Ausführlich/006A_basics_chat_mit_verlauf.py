...
st.markdown("**Lernziel:** Beschreibe, wie ein Chat mit Gesprächsverlauf technisch umgesetzt wird.")
...
if st.button("Ausführen"):
    if not txt.strip():
        ...
        prompt = "Beschreibe, wie ein Chat mit Gesprächsverlauf technisch umgesetzt wird." + "\n\nText:\n" + txt.strip()
        if extra.strip():
            prompt += "\n\nZusatz:\n" + extra.strip()
