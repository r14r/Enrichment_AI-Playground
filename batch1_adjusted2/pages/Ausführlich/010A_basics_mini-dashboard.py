...
st.markdown("**Lernziel:** Skizziere ein kleines Dashboard, das Status und Schnell-Prompt kombiniert.")
...
if st.button("Ausführen"):
    if not txt.strip():
        ...
        prompt = "Skizziere ein kleines Dashboard, das Status und Schnell-Prompt kombiniert." + "\n\nText:\n" + txt.strip()
        if extra.strip():
            prompt += "\n\nZusatz:\n" + extra.strip()
